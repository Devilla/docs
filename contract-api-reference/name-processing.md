---
description: Describes how to normalize and hash PNS names.
---
...
The [eth-ens-namehash](https://www.npmjs.com/package/@pnsdomains/eth-ens-namehash) Javascript library performs both normalization and hashing as described here. All of the [PNS libraries](../dapp-developer-guide/pns-libraries.md) covered in the DApp Developer Guide also perform normalization and hashing.
...
In some cases, you may need to know the hash of the name stored in PNS. labelhash means hash of the label of the domain \(eg: `makoto` for `makoto.eth`\) and namehash is the hash which combines labelhashes. We are currently working to include this information in our Manager app. In the meantime, you can query the information via [https://thegraph.com/explorer/subgraph/pnsdomains/pns](https://thegraph.com/explorer/subgraph/pnsdomains/pns) with the following query.
